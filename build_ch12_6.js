...
fs.writeFileSync('injector_ch12_part6.js', ch12ContentPart6);

// Now combine everything
const part1 = fs.readFileSync('injector_ch12_part1.js', 'utf8');
const part2 = fs.readFileSync('injector_ch12_part2.js', 'utf8');
const part3 = fs.readFileSync('injector_ch12_part3.js', 'utf8');
const part4 = fs.readFileSync('injector_ch12_part4.js', 'utf8');
const part5 = fs.readFileSync('injector_ch12_part5.js', 'utf8');
const part6 = fs.readFileSync('injector_ch12_part6.js', 'utf8');

const finalCh12 = part1 + part2 + part3 + part4 + part5 + part6;

fs.writeFileSync('injector_ch12.js', finalCh12);
console.log('Successfully combined and wrote injector_ch12.js');
